...
interface IMemo {
    function rebase( uint256 TempoProfit_, uint epoch_) external returns (uint256);
...
contract TempoStaking is Ownable {
    ...
    /**
        @notice stake Tempo to enter warmup
        @param _amount uint
        @return bool
     */
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        IERC20( Tempo ).safeTransferFrom( msg.sender, address(this), _amount );
    ...
    /**
        @notice retrieve sTempo from warmup
    ...
    /**
        @notice forfeit sTempo in warmup and retrieve Tempo
     */
    function forfeit() external {
        ...
        IERC20( Tempo ).safeTransfer( msg.sender, info.deposit );
    }
    ...
    /**
        @notice redeem sTempo for Tempo
        @param _amount uint
        @param _trigger bool
     */
    function unstake( uint _amount, bool _trigger ) external {
        ...
        IERC20( Tempo ).safeTransfer( msg.sender, _amount );
    }

    /**
        @notice returns the sTempo index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract Tempo holdings, including bonuses provided
        @return uint
     */
    function contractBalance() public view returns ( uint ) {
        return IERC20( Tempo ).balanceOf( address(this) ).add( totalBonus );
    }
