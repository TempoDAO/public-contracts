...
interface IERC20 {
   ...
   * that someone may use both the old and the new allowance by unTempounate
...
contract sTempo is ERC20Permit, Ownable {
    ...
    /**
        @notice increases sTempo supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTempo
